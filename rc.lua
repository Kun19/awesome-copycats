...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Control" }, "p",     function () awful.tag.incncol( 1, nil, true)    end,
    ...
    awful.key({ modkey, "Shift" }, "t", function () awful.spawn(guieditor) end,
              {description = "run gui editor", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "f", function () awful.spawn(file_browser) end,
              {description = "run file browser", group = "launcher"}),

    -- Default
    awful.key({ modkey }, "ü", function() menubar.show() end,
